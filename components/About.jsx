        ...
        <div className="container" data-aos="fade-up">
          <div className="row content">
            ...
            <div className="col-lg-6 pt-4 pt-lg-0" data-aos="fade-left">
              <p>
                Rayen Ltd, founded in 2020, offers services such as management
                consulting, venture capital, debt, and private equity financing.
              ...
              <p className="fst-italic">
                Rayen Ltd is based in Lilongwe, Malawi, and serves both local and international clients.
              </p>
            </div>
          </div>
        </div>
