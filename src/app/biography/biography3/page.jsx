...
export default function Biography() {
  return (
    <div className="container mx-auto mt-20 px-20 py-10">
      ...
      He manages and analyses data for management decision making. he has extensive experience in data magement and he has worked in various industries in that capacity He possess an Msc in Informatics
      </p>
