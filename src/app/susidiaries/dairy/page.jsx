...
<div className="px-10 px-lg-20">
      ...
      <div className="about-section">
        <div className="text-container">
          <h2>About Rayen Dairy</h2>
          <p>
            At Rayen Dairy, we are committed to providing premium dairy products
            sourced from the best farms in the region. Our focus is on
            delivering fresh, nutritious, and sustainably produced milk, yogurt,
            and cheese to meet your dietary needs.
          </p>
        </div>
              ...
              <div className="tab-style1 horizontaltab">
                ...
                >
                  ...
                  <div className="text-center mb-5">
                    ...
                    <p>
                      Milk, Dairy Products, Dairy Cattle Breeding, Manure and
                      Liquid Fertilizer Production.on
                    </p>
                  </div>
                  ...
                  <div className="text-center mb-5">
                    ...
                    <p>
                      Middle class consumers, Farmers, NGOs and sister companies
                    </p>
                  </div>
                </div>
              </div>
