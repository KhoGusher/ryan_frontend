...
<div className="px-10 px-lg-20">
      ...
      <div className="about-section">
        <div className="text-container">
          <h2>About Rayen Poultry</h2>
          <p>
            Rayen Poultry is dedicated to raising and delivering the finest
            poultry products in the region. Our farms follow best practices in
            poultry farming, ensuring that our chickens are raised in a humane,
            healthy environment. From free-range eggs to high-quality meat,
            Rayen Poultry provides nutritious options for your family.
          </p>
              ...
              <div className="tab-style1 horizontaltab">
                ...
                >
                  ...
                  <div className="text-center mb-5">
                    ...
                    <p>Poultry and Rabbits Production</p>
                  </div>
                  ...
                  <div className="text-center mb-5">
                    ...
                    <p>Middle class consumers and Institutions</p>
                  </div>
                </div>
              </div>
            </div>
