...
<div className="about-section">
      <div className="text-container">
        ...
        <p>
          ...
          businesses across the region. With a focus on sustainability and local
          sourcing, we ensure that every product is crafted with care and
          delivered with passion which covers{" "}
      ...
      <div>
        <div className="accordion">
          ...
          <div className="accordion-item">
            ...
            >
              <p>Muwawane Village, Chiwamba EPA, TA Chimutu, Lilongwe, Malawi.</p>
            </div>
          </div>
      ...
      <div className="col-lg-6 mb-4 mb-lg-0">
        <div className="about-img position-relative">
          <div className="image-box">
            ...
            {/* Uncomment this block to add a second image */}
            {/* <div className="image-2">
              <Image
                src="/assets/img/foods/pic-2.webp"
                className="rounded"
                alt="Image 2"
                width={500}
                height={500}
        ...
        <div className="content-box">
          <div className="row border-md-bottom clearfix pb-md-5 mb-5 mb-md-7">
            <div className="tab-style1 horizontaltab">
              <div className="resp-tabs-container hor_1" style={{ marginTop: "50px" }}>
                {/* Primary Interest */}
                <div className="text-center mb-5">
                  <h2>
                    <span style={{ color: "steelblue" }}>Primary</span> Interest
                  </h2>
                ...
                <div className="text-center mb-5">
                  <h2>
                    Secondary <span style={{ color: "steelblue" }}>Interest</span>
                  </h2>
                  <p>
                    Knowledge and practical training centre for students and local farmers, job provision to the youth and women.
                  </p>
                </div>
                ...
                <div className="text-center mb-5">
                  ...
                  <p>Middle class consumers, Institutions and sister companies.</p>
                </div>
              </div>
            </div>
          </div>
